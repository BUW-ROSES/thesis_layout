...
\begin{itemize}
    ...
    \begin{description}
        \item[Bachelor's theses] should have a length of 30-50 content pages, with a tendency towards 30 pages if the thesis is implementation heavy.
        \item[Master's theses] should have a length of 50-70 content pages, with a tendency towards 50 pages if the thesis is implementation heavy.
    \end{description}
